	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">LEAGUE OF PIZZA</a>
			</div>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Produto:</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Preço</td><td><b><?php echo "$ ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Quantidade</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Id para transação</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
